      ...
      <div className="bg-white border border-red-100 rounded-2xl p-6 w-full max-w-md shadow-xl animate-in fade-in zoom-in-95 duration-150">
        <div className="flex items-center justify-between pb-3 border-b border-stone-100 mb-4">
          <div className="flex items-center gap-2 text-red-600">
            ...
            <h3 className="font-semibold text-base text-stone-900">Delete Image Artifact</h3>
          </div>
          <button
            onClick={onClose}
            type="button"
        ...
        <div className="space-y-3 mb-6">
          <p className="text-sm text-stone-700">
            Are you sure you want to delete <span className="font-semibold text-stone-900">"{artifactTitle || 'Untitled Image'}"</span>?
          </p>
          <p className="text-xs text-stone-500">
            This will permanently remove the image record from your subject's artifacts catalog.
          </p>
